...
def rotate(direction, position):
    temporarySet = myCubesState

    if(direction == 'down' and postion == 1):
            myCubesState[1] = temporyarSet[37]
    ...
    if(direction == 'down' and position == 3):
            myCubesState[3] = temporyarSet[39]
